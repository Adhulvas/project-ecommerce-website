        ...
        <div className="container mx-auto p-6 bg-gray-100 mt-16">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 w-3/4 mx-auto">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="mb-4">
                        <label className="block text-sm font-medium text-gray-700" htmlFor="isTrending">Is Trending</label>
                        <input 
                            type="checkbox" 
                            id="isTrending" 
                            {...register('isTrending')} 
                    ...
                    <div className="flex justify-center">
                        <button type="submit" className="bg-green-500 text-white py-2 px-4 rounded transition-transform active:scale-95 active:shadow-inner">
                            Add Product
                        </button>
                    </div>
                </form>
